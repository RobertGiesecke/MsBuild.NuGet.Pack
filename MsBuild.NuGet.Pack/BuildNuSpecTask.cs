namespace MsBuild.NuGet.Pack
{
  ...
  public class BuildNuSpecTask : ITask
  {
    ...
    public bool Execute()
    {
      ...
      {
        Arguments = "pack \"" + NuSpecPath + "\"" + (CreateSymbolsPackage ? " -Symbols" : ""),
        CreateNoWindow = true,
    ...
    /// <summary>
    /// Create a symbols package (to be deployed to a symbols server like symbolsource.org)
    /// </summary>
    [Required]
    public bool CreateSymbolsPackage
    {
      get;
      set;
    }
